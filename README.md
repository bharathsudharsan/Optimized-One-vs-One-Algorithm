...
The *Opt-OVO* algorithm detailed explanation available in [Opt-OVO-Algorithm.pdf](https://github.com/bharathsudharsan/Optimized-One-vs-One-Algorithm/blob/main/Opt_OVO_Algorithm.pdf)
